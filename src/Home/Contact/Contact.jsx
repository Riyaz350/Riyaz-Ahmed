        ...
        <div className="lg:grid grid-cols-2 max-w-5xl mx-auto md:border-4 mt-2  border-[#f71735] p-2 lg:p-10">
            <div className="col-span-1 flex flex-col justify-center text-xl lg:text-3xl gap-10 ">
                ...
                <div className='flex flex-col gap-2  '>
                    ...
                    <div className='flex gap-2 items-center justify-center lg:justify-start'><img className='w-fit' src="https://i.ibb.co/MNL6VT3/icons8-call.gif" alt="" /><p>Address: Brahmanbaria, Bangladesh</p></div>
